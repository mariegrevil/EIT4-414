// ======================================================================
// Blinki.v generated from TopDesign.cysch
// 03/09/2020 at 15:02
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e8b96dc1-dd38-4c64-85f0-bc0e8484a612"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9f0b884b-9d83-494a-a28f-a4ac2ec4ab1f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dd614629-0655-4fe2-9605-cd6c6376d15b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Red1 (
        .connect({
            Net_7,
            Net_8
        })
    );
    defparam Red1.comp_name = "LED_v1_0";
    defparam Red1.port_names = "A, K";
    defparam Red1.width = 2;
    ...
    assign Net_14 = ~Net_17;


    assign Net_16 = ~Net_17;
