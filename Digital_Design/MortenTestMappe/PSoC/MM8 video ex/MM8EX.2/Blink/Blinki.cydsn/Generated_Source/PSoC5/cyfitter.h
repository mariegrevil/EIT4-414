...
/* Blue */
#define Blue__0__INTTYPE CYREG_PICU2_INTTYPE6
#define Blue__0__MASK 0x40u
#define Blue__0__PC CYREG_PRT2_PC6
#define Blue__0__PORT 2u
#define Blue__0__SHIFT 6u
#define Blue__AG CYREG_PRT2_AG
#define Blue__AMUX CYREG_PRT2_AMUX
#define Blue__BIE CYREG_PRT2_BIE
#define Blue__BIT_MASK CYREG_PRT2_BIT_MASK
#define Blue__BYP CYREG_PRT2_BYP
#define Blue__CTL CYREG_PRT2_CTL
#define Blue__DM0 CYREG_PRT2_DM0
#define Blue__DM1 CYREG_PRT2_DM1
#define Blue__DM2 CYREG_PRT2_DM2
#define Blue__DR CYREG_PRT2_DR
#define Blue__INP_DIS CYREG_PRT2_INP_DIS
#define Blue__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Blue__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Blue__LCD_EN CYREG_PRT2_LCD_EN
#define Blue__MASK 0x40u
#define Blue__PORT 2u
#define Blue__PRT CYREG_PRT2_PRT
#define Blue__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Blue__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Blue__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Blue__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Blue__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Blue__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Blue__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Blue__PS CYREG_PRT2_PS
#define Blue__SHIFT 6u
#define Blue__SLW CYREG_PRT2_SLW
